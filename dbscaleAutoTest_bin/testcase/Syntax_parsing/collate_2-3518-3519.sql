...
--create table ，char字段，编码utf8mb4，collate使用utf8mb4_bin  3518 
...
sql:insert into test1.tb_char_utf8mb4_bin (c1) values ("c");
sql:insert into test1.tb_char_utf8mb4_bin (c1) values ("d");
sql:select TABLE_NAME,COLLATION_NAME,DATA_TYPE from information_schema.columns where table_schema = "test1" and table_name = "test1.tb_char_utf8mb4_bin";
sql:select distinct c1 from  test1.tb_char_utf8mb4_bin;
sql:select id,c1 from  test1.tb_char_utf8mb4_bin order by c1;
sql:select c1 from  test1.tb_char_utf8mb4_bin group by c1;
sql:select id,c1 from  test1.tb_char_utf8mb4_bin having id < 8;
sql:select id,c1 from  test1.tb_char_utf8mb4_bin where id > 5;
sql:drop database test1;

--create table ，char字段，编码utf8mb4，collate使用utf8mb4_general_ci 3519 
sql:create database test1;
...
sql:insert into test1.tb_char_utf8mb4_general_ci (c1) values ("c");
sql:insert into test1.tb_char_utf8mb4_general_ci (c1) values ("d");
sql:select TABLE_NAME,COLLATION_NAME,DATA_TYPE from information_schema.columns where table_schema = "test1" and table_name = "test1.tb_char_utf8mb4_general_ci";
sql:select distinct c1 from  test1.tb_char_utf8mb4_general_ci;
sql:select id,c1 from  test1.tb_char_utf8mb4_general_ci order by c1;
sql:select c1 from  test1.tb_char_utf8mb4_general_ci group by c1;
sql:select id,c1 from  test1.tb_char_utf8mb4_general_ci having id < 8;
sql:select id,c1 from  test1.tb_char_utf8mb4_general_ci where id > 5;
sql:drop database test1;
